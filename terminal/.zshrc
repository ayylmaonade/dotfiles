...
echo "useful cmds: find, locate, whereis, which, file, getfacl, stat, du" | lolcat
...
##echo "Put 'perl5' back in the home folder if errors occur! It's currently in ~/Desktop!"
